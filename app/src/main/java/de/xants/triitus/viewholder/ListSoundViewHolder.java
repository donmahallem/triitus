...
import de.xants.triitus.picasso.CircleTransformation;

/**
 * Created by Don on 14.10.2015.
 */
public final class ListSoundViewHolder extends BaseSoundViewHolder {

    public ListSoundViewHolder(@NonNull ViewGroup viewGroup) {
        super(viewGroup, R.layout.vh_sound_list);
    }
